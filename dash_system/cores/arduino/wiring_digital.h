/*
  wiring_digital.h - Wiring compatibility layer digital-mode
 ...
 */
extern void pinMode( uint32_t io, uint32_t mode ) ;
 ...
 */
extern void digitalWrite( uint32_t io, uint32_t val ) ;
 ...
 * \return HIGH or LOW
 */
extern int digitalRead( uint32_t io ) ;

extern void digitalToggle( uint32_t io );
